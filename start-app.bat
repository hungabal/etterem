...
if exist "C:\Program Files\Mozilla Firefox\firefox.exe" (
    echo Firefox found, opening application with Firefox in private browsing mode...
    start "" "C:\Program Files\Mozilla Firefox\firefox.exe" -private-window "http://%IP%:3003"
) else if exist "C:\Program Files (x86)\Mozilla Firefox\firefox.exe" (
    echo Firefox found, opening application with Firefox in private browsing mode...
    start "" "C:\Program Files (x86)\Mozilla Firefox\firefox.exe" -private-window "http://%IP%:3003"
) else (
